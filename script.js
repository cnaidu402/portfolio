...
const customDescriptions = {
    ...
    'citymind-multi-agent-ai-for-urban-planning': "CityMind is a sophisticated urban planning simulator that leverages a multi-agent AI architecture to evaluate development sites across Maryland. Built with a modular backend, it orchestrates five specialized agents—Environmental, Safety, Transit, Infrastructure, and ROI—to perform real-time geospatial analysis using Maryland iMAP and OpenStreetMap data."
};
